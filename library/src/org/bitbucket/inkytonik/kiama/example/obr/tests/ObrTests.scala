...
class ObrRegressionTests extends Driver with TestCompilerWithConfig[ObrInt, ObrConfig] {
    ...
    filetests("ObrRegression", "src/org/bitbucket/inkytonik/kiama/example/obr/tests/generic", ".obr", ".risc",
        argslist = List(Seq("-a")))
...
class ObrParserTests extends ParserDriver with TestCompilerWithConfig[ObrInt, ObrConfig] {
    ...
    filetests("ObrParserEnum", "src/org/bitbucket/inkytonik/kiama/example/obr/tests/enum/parser", ".obr", ".out")
    filetests("ObrParserException", "src/org/bitbucket/inkytonik/kiama/example/obr/tests/exceptions/parser", ".obr", ".out")
...
class ObrSemanticTests extends SemanticDriver with TestCompilerWithConfig[ObrInt, ObrConfig] {
    ...
    filetests("ObrSemanticEnum", "src/org/bitbucket/inkytonik/kiama/example/obr/tests/enum/semantic", ".obr", ".out")
    filetests("ObrSemanticException", "src/org/bitbucket/inkytonik/kiama/example/obr/tests/exceptions/semantic", ".obr", ".out")
...
class ObrExecTests extends Driver with TestCompilerWithConfig[ObrInt, ObrConfig] {
    ...
    filetests("ObrExec", "src/org/bitbucket/inkytonik/kiama/example/obr/tests/generic", ".obr", ".out",
    ...
    val forExecDir = "src/org/bitbucket/inkytonik/kiama/example/obr/tests/for/codegen/"
    ...
    val enumExecDir = "src/org/bitbucket/inkytonik/kiama/example/obr/tests/enum/codegen/"
    ...
    val exceptionsExecDir = "src/org/bitbucket/inkytonik/kiama/example/obr/tests/exceptions/codegen/"
