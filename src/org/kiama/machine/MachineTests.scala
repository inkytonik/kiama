...
class MachineTests extends FunSuite {
    ...
    test ("new parameterised state is undefined") {
        ...
        expect (true) (p.isUndefined (0))
        expect (true) (p.isUndefined (42))
        expect (true) (p.isUndefined (99))
    }
    ...
    test ("undefined parameterised state is not equal to anything") {
        ...
        expect (false) (p ("one") =:= 0)
        expect (false) (p ("one") =:= 42)
        expect (false) (p ("one") =:= 99)
    }
    ...
    test ("defined parameterised state is only equal to its value") {
        ...
        expect (true) (p ("one") =:= 42)
        expect (false) (p ("one") =:= 99)
        expect (false) (p ("two") =:= 0)
        expect (false) (p ("two") =:= 42)
        expect (true) (p ("two") =:= 99)
    }
